...
print('control platform')
import example.controlPlatform
import example.controlPlatformAlt
import example.controlPlatformPrint

print('cradle')
import example.cradle_tall
import example.cradle
...
print('spool')
import example.spool_no_center
...
print('stair lift')
import example.stairLift

print('steel frame')
import example.steelFrame